...
def vgg11(pretrained=False, in_channels=1, **kwargs):
...
def vgg11_bn(pretrained=False, in_channels=1, **kwargs):
...
def vgg13(pretrained=False, in_channels=1, **kwargs):
...
def vgg13_bn(pretrained=False, in_channels=1, **kwargs):
...
def vgg16(pretrained=False, in_channels=1, **kwargs):
...
def vgg16_bn(pretrained=False, in_channels=1, **kwargs):
...
def vgg19(pretrained=False, in_channels=1, **kwargs):
